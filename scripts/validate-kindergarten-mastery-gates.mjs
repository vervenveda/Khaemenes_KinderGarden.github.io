...
assert.ok(gate.includes('const VERSION="1.2.12"'),"mastery engine must remain on Week 17 rollout contract or later");
for(const marker of [
...
console.log("- Week 17 preserves shadow science, fair measurement, Earth-rotation/day-night reasoning, global season accuracy, model limits, and light safety");
